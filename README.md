...
| An attempt has been made to style the user interface using CSS, either hand-written or using a framework. ***There may be some minor flaws and it may not work well on mobile.*** |  | ✓ | ✓ | ✓ | ✓ | ✓ | ✓
