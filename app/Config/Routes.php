...
$routes->get('/golf/booking/(:num)', 'golf::booking/$1'); // GET: For editing existing bookings
$routes->get('/golf/booking/(:num)', 'golf::booking/$1/POST'); // POST: For editing existing bookings
